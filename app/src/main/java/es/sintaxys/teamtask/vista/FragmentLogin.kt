...
import es.sintaxys.teamtask.databinding.FragmentLoginBinding
import es.sintaxys.teamtask.viewmodel.VistaModeloAuth
...
class FragmentLogin : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.botonTransparente.setOnClickListener {
            findNavController().navigate(es.sintaxys.teamtask.R.id.action_fragment_Login_to_fragment_Registro)
        }
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(getString(es.sintaxys.teamtask.R.string.google_client_id))
            .requestEmail()
            .build()
        ...
        vistaModeloAuth.usuario.observe(viewLifecycleOwner) { usuario ->
            if (usuario != null) {
                ...
                viewLifecycleOwner.lifecycleScope.launch {
                    ...
                    findNavController().navigate(es.sintaxys.teamtask.R.id.action_fragment_Login_to_fragment_PgPrincipal)
                }
            }
        }
