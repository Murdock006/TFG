        ...
        btnGenerarInvitacion.setOnClickListener {
            ...
            parejaVM.crearInvitacion(grupo.id, usuarioId, null) { invRes ->
                if (invRes.isSuccess) {
                    ...
                    tvCodigo.text = getString(es.sintaxys.teamtask.R.string.grupo_creado_codigo, codigo ?: grupo.id)
                    Toast.makeText(requireContext(), getString(es.sintaxys.teamtask.R.string.grupo_creado_codigo, codigo ?: grupo.id), Toast.LENGTH_LONG).show()
                } else {
