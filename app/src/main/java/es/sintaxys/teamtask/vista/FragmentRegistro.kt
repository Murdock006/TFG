...
import es.sintaxys.teamtask.databinding.FragmentRegistroBinding
...
class FragmentRegistro : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val sexoOpciones = listOf(
            getString(es.sintaxys.teamtask.R.string.sexo_opcion_masculino),
            getString(es.sintaxys.teamtask.R.string.sexo_opcion_femenino),
            getString(es.sintaxys.teamtask.R.string.sexo_opcion_otro),
            getString(es.sintaxys.teamtask.R.string.sexo_opcion_no_decir)
        )
